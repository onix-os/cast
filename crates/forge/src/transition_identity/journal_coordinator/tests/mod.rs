...
use super::system_triggers::{
    ActiveReblitBootSyncHandoffFailure, ActiveReblitNoBootCommitDecisionFailure, BoundSystemTriggerAdvanceFailure,
    DurableSystemTriggerRecord, StatefulSystemTriggerFailure, arm_after_bound_successor_same_store_validation,
...
const COORDINATOR_SYSTEM_SNAPSHOT: &[u8] =
    b"// @generated by cast. DO NOT EDIT.\nlet system = { hostname = \"coordinator-test\" } in system\n";
...
pub(crate) struct CoordinatorFixture {
    ...
    pub(crate) database: db::state::Database,
    pub(crate) layout_database: db::layout::Database,
    pub(crate) previous_state: state::Id,
    pub(crate) candidate_state: state::Id,
