...
pub(in crate::client) use capture::{
    ...
    ActiveReblitWrapperReservationFault, NewStateCandidatePreserveMoveFault, NewStateTargetCreateFault,
    ...
    arm_active_reblit_wrapper_reservation_fault,
    ...
    reset_active_reblit_wrapper_reservation_attempt_count, reset_new_state_candidate_preserve_move_attempt_count,
