...
#[test]
fn startup_archived_candidate_preserve_bound_advance_same_byte_replacements_never_succeed() {
...
#[test]
fn startup_archived_candidate_preserve_same_byte_successor_replacement_after_publication_fails_exact_binding() {
    for epoch in Epoch::ALL {
        for source in CandidateSource::ALL {
            for origin in CandidateOrigin::ALL {
                for usr_outcome in [RollbackActionOutcome::Applied, RollbackActionOutcome::AlreadySatisfied] {
                    ...
                    arm_before_usr_rollback_archived_candidate_preserve_successor_binding_revalidation(hook);
        ...
        for source in CandidateSource::ALL {
            for origin in CandidateOrigin::ALL {
                for usr_outcome in [RollbackActionOutcome::Applied, RollbackActionOutcome::AlreadySatisfied] {
                    ...
                    arm_after_usr_rollback_archived_candidate_preserve_successor_binding_check_before_reopen(hook);
