use super::*;
use crate::db::state::{BootPublicationReceiptPromotionDurableState, BootPublicationReceiptPromotionError};
...
fn ambiguous_commit_report_preserves_promoted_classification_without_success_authority() {
    with_staged_alias_attempt!(|fixture,
        ...
        db::state::arm_boot_publication_receipt_promotion_after_commit_error(db::Error::RowNotFound);
