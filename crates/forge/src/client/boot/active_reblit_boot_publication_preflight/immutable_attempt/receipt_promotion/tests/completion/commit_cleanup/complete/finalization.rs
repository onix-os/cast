...
use crate::{
    client::{
        ...
        startup_recovery::{
            ActiveReblitCompleteFinalizationError, arm_before_active_reblit_complete_finalization_final_revalidation,
        },
    },
    transition_journal::{
        TransitionJournalRecordDeleteError, TransitionJournalRecordDeleteState, TransitionJournalStore,
...
pub(super) const SCENARIO_COUNT: usize =
    SUCCESS_SCENARIO_COUNT + BINDING_REJECTION_SCENARIO_COUNT + DELETE_FAULT_SCENARIO_COUNT;

#[test]
fn exact_complete_finalizes_once_and_preserves_clean_authority() {
    with_exact_complete_handoff!(|fixture, topology_fixture, plan, client, completed| {
        ...
        assert!(
            TransitionJournalStore::try_open_in_retained_cast(cast, &fixture.installation.root,).is_err(),
        ...
        let reopened = TransitionJournalStore::try_open_in_retained_cast(
            fixture.installation.retained_mutable_cast_directory().unwrap(),
