...
fn pre_effect_journal_identity_drift_fails_before_any_publication() {
    support::with_staged_alias_attempt!(|fixture,
                                         topology_fixture,
                                         plan,
                                         _inventory,
                                         client,
        ...
        let displaced = canonical.parent().unwrap().join("pre-effect-displaced-transition");
...
fn immediate_post_schedule_journal_drift_fails_before_any_effect() {
    support::with_staged_alias_attempt!(|fixture,
                                         ...
                                         fingerprint| {
        let canonical = fixture.installation.root.join(".cast/journal/state-transition");
        let displaced = canonical.parent().unwrap().join("post-schedule-displaced-transition");
