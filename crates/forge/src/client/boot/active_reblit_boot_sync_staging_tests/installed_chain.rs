...
fn second_boot_sync_journal(
    ...
    preparing.transition_id = TransitionId::parse("fedcba9876543210fedcba9876543210").unwrap();
...
fn promoted_a_is_authenticated_as_b_predecessor_and_retained_delta_input() {
    with_bound_staging_plan!(|fixture, plan, inventory, historical_claims| {
        ...
        let receipt_a = plan
            .prepare_complete_boot_publication_receipt(&inventory, &historical_predecessor, None, &historical_claims)
            .unwrap();
        fixture.state_db.stage_boot_publication_receipt(&receipt_a).unwrap();
        assert_eq!(
            fixture
                .state_db
        ...
        let (journal, predecessor, binding) = second_boot_sync_journal(&fixture.installation);
