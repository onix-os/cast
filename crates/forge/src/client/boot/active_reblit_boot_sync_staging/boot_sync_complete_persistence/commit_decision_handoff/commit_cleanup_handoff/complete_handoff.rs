...
use super::{CommitCleanupCompleteStagedActiveReblitBootSync, exact_live_options, receipt_pair};
...
pub(in crate::client) struct CompleteStagedActiveReblitBootSync<'plan, 'inventory, Plan> {
...
impl<'plan, 'inventory, Plan> CompleteStagedActiveReblitBootSync<'plan, 'inventory, Plan> {
    ...
    pub(in crate::client) fn revalidate_against(
        ...
        {
            return Err(CompleteStagedActiveReblitBootSyncValidationError::ClientCapabilityMismatch);
        }
