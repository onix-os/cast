...
use crate::package::{self, Name};
use crate::{Client, Installation, Provider, environment};
use strum::Display;
use tui::Styled;
...
mod tests {
    ...
    use crate::Registry;
    use crate::package::{self, Name, Package};
    ...
    /// TODO: `cast search` could eventually provide results on binary names by default
    #[test]
