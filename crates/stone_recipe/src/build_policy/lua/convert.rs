//! Lua build-policy DTOs and their conversions into the domain spec tree.
//!
//! Split out of the parent `lua` module to keep individual source files within
//! the repository's per-file line budget. The evaluator and the Lua encoder
//! that consume these types live in `super`.
...
use super::super::{
    ...
    BuildCommandSpec, BuildPolicyPatchSpec, BuildPolicySpec,
    ...
    SandboxPolicySpec, SourcePreparationPolicySpec,
