...
fn encode_package_v3(
    ...
    let builder_module = match build_system {
        build::System::Cmake => Some("cast.builders.cmake.v2"),
        build::System::Meson => Some("cast.builders.meson.v2"),
        build::System::Cargo => Some("cast.builders.cargo.v2"),
        build::System::Autotools => Some("cast.builders.autotools.v2"),
        _ => None,
    };
