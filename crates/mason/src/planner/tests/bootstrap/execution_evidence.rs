...
const EXPECTED_EXECUTIONS: u64 = 56;
const EXPECTED_BUNDLE_VALIDATIONS: u64 = 84;
const EXPECTED_STONES: u64 = 134;
const EXPECTED_MANIFESTS: u64 = 56;
const EXPECTED_ARTIFACTS: u64 = 190;
