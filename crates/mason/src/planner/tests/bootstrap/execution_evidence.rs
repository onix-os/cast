...
const EXPECTED_EXECUTIONS: u64 = 42;
const EXPECTED_BUNDLE_VALIDATIONS: u64 = 63;
const EXPECTED_STONES: u64 = 126;
const EXPECTED_MANIFESTS: u64 = 42;
const EXPECTED_ARTIFACTS: u64 = 168;
