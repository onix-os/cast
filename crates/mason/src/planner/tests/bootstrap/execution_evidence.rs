...
const EXPECTED_EXECUTIONS: u64 = 44;
const EXPECTED_BUNDLE_VALIDATIONS: u64 = 66;
const EXPECTED_STONES: u64 = 127;
const EXPECTED_MANIFESTS: u64 = 44;
const EXPECTED_ARTIFACTS: u64 = 171;
