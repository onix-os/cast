...
const EXPECTED_EXECUTIONS: u64 = 46;
const EXPECTED_BUNDLE_VALIDATIONS: u64 = 69;
const EXPECTED_STONES: u64 = 128;
const EXPECTED_MANIFESTS: u64 = 46;
const EXPECTED_ARTIFACTS: u64 = 174;
