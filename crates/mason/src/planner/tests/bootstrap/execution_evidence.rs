...
const EXPECTED_EXECUTIONS: u64 = 48;
const EXPECTED_BUNDLE_VALIDATIONS: u64 = 72;
const EXPECTED_STONES: u64 = 129;
const EXPECTED_MANIFESTS: u64 = 48;
const EXPECTED_ARTIFACTS: u64 = 177;
