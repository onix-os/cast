...
use declarative_config::{
    ...
    Evaluation as CoreEvaluation, EvaluationDeadline, EvaluationIdentity,
...
use crate::{
    Diagnostic, GLUON_VERSION, gluon_configuration_abi, gluon_evaluator_policy,
...
impl<T> From<CoreEvaluation<T, EvaluationIdentity>> for Evaluation<T> {
    fn from(evaluation: CoreEvaluation<T, EvaluationIdentity>) -> Self {
        Self {
...
impl EngineAdapter for GluonEngine {
    ...
    fn build_identity(
        ...
        EvaluationIdentity::new_checked(
            &self.language_spec,
            &gluon_configuration_abi(),
            &gluon_evaluator_policy(),
            &self.limits,
            inputs.root(),
            inputs.graph(),
