...
include misc/make/startup-active-reblit-boot-repair-complete-tests.mk misc/make/startup-active-reblit-boot-sync-complete-tests.mk misc/make/startup-active-reblit-commit-cleanup-authority-tests.mk misc/make/startup-active-reblit-commit-cleanup-effect-tests.mk misc/make/startup-active-reblit-commit-cleanup-dispatch-tests.mk misc/make/startup-active-reblit-commit-cleanup-complete-tests.mk
