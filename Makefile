...
include misc/make/active-reblit-boot-namespace-input-tests.mk misc/make/active-reblit-boot-publication-preflight-tests.mk misc/make/active-reblit-boot-immutable-publication-attempt-tests.mk misc/make/active-reblit-boot-terminal-promotion-tests.mk
