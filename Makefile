...
include misc/make/boot-publication-receipt-state-tests.mk misc/make/boot-publication-receipt-promotion-tests.mk misc/make/boot-publication-installed-receipt-tests.mk
