...
Linux MSDOS magic family. This still does not prove the on-disk GPT type GUIDs
or physical-disk identity, authorize writes, or establish durability. Because
