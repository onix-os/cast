...
return {
    ...
    outputs = {
        ...
        },
        {
            ...
            summary = {
                kind = "some",
                value = "Documentation for override-client"
            },
            description = {
                kind = "some",
        ...
        },
        {
            ...
            summary = {
                kind = "some",
                value = "Development files for override-client"
            },
            description = {
                kind = "some",
        ...
        },
        {
            ...
            summary = {
                kind = "some",
                value = "Debugging symbols for override-client"
            },
            description = {
                kind = "some",
        ...
        },
        {
            ...
            summary = {
                kind = "some",
                value = "Library files for override-client"
            },
            description = {
                kind = "some",
        ...
        },
        {
            ...
            summary = {
                kind = "some",
                value = "Debugging symbols for override-client-32bit"
            },
            description = {
                kind = "some",
        ...
        },
        {
            ...
            summary = {
                kind = "some",
                value = "Example files for override-client"
            },
            description = {
                kind = "some",
                value = "Example files for the override-client package"
            },
            provides_exclude = {},
            runtime_inputs = {},
            runtime_exclude = {},
        ...
        },
        {
            ...
            paths = {
                {
                    kind = "exe",
                    path = "/usr/bin/override-client-diagnose"
                }
            },
            conflicts = {}
        }
