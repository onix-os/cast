...
Accepted commits `4d1f8ceb`, `12f888e1`, `323f776e`, and `fffb79f7` now provide the immutable aggregate attempt, real GPT alias/distinct remount evidence, exact receipt promotion, and consuming terminal-evidence authority. The last boundary leaves the journal exactly at `BootSyncStarted`, returns no token after ambiguous database reporting or any later drift, and passes 20/20 bridge plus 18/18 database tests. `BootSyncComplete`, replacement/deletion, live wiring, selected-payload bootability, same-receipt recovery, reboot, and power-loss durability remain open.
...
Disk admissibility beyond the admitted evidence, journal-coupled aggregate write authority and durable publication, device-flush ordering, and restart reconciliation remain open.
