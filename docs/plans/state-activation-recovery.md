...
- [ ] Open mutable system clients in recovery order: installation lock,
  ...
  Caller-supplied provenance claims are not authenticated effect authority; promotion, journal-coupled aggregate publication/live wiring, mutation/deletion, selected-payload bootability, reboot, and power-loss proof remain open.
...
Pending promotion, journal-coupled aggregate publication/live wiring, boot mutation/deletion authority, selected-payload bootability, reboot, and power-loss proof remain open.
...
Promotion, journal-coupled aggregate publication, deletion, live wiring, selected-payload bootability, publication durability, and recovery VM evidence remain open.
