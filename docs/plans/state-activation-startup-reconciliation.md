...
## Remaining recovery campaign
  ...
  `CommitDecided` cleanup, current receipt-head cleanup, later roll-forward through `Complete` and finalization, boot replacement/deletion and selected-payload bootability, process death, reboot, and power-loss proof remain open; long-term immutable-body GC remains deferred.
