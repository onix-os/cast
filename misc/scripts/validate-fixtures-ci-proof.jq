...
and (
  ...
  and $proof.totals.fixture_count == 16
  and $proof.totals.execution_count == 32
  and $proof.totals.bundle_validation_count == 48
  and $proof.totals.stone_count == 104
  and $proof.totals.manifest_count == 32
  and $proof.totals.artifact_count == 136
