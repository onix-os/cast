...
sed '0,/"fixture_count": 26,/s//"fixture_count": 26,\n    "fixture_count": 26,/' \
...
mutate_and_reject last-fixture-coordinated-ledger-forgery \
    '.fixtures[25].artifacts.ledger_sha256 = "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
     | .fixtures[25].bundle_observations[].ledger_sha256 = "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"'
