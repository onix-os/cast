...
help:
	...
	@echo "  bootstrap-fixtures-prepare  Fetch and verify the pinned 147-package Stone closure"
	@echo "  bootstrap-fixtures-offline  Build selected fixtures twice without downloading"
	@echo "                    Set FIXTURE=all (default) or one of the twenty-two fixture names"
	@echo "                    Set REQUIRE_EXECUTION=1 to reject namespace-capability skips"
	@echo "  fixtures-ci    Required-capability twenty-two-fixture execution and reproduction gate"
