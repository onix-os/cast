...
help:
	...
	@timeout 10s echo "  forge-startup-usr-rollback-activate-archived-complete-route-test  Run test-sealed ActivateArchived rollback-completion routing contracts"
	...
	@echo "                    Set FIXTURE=all (default) or one of the seventeen fixture names"
	@echo "                    Set REQUIRE_EXECUTION=1 to reject namespace-capability skips"
	@echo "  fixtures-ci    Required-capability seventeen-fixture execution and reproduction gate"
