...
forge-startup-active-reblit-commit-cleanup-authority-test:
	...
	for name in \
		...
		exact_system_triggered_no_boot_authorities_preserve_unrelated_receipts \
	...
	grep -Fq 'ActiveReblitCommitCleanupRouteEvidence::NoBoot' "$$authority"; \
	grep -Fq 'load_current_exact_promoted_boot_publication_receipt_chain' "$$authority"; \
