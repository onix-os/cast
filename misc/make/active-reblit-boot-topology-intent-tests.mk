...
forge-active-reblit-boot-topology-intent-test:
	@set -euo pipefail; \
	...
	timeout 10s test "$$( timeout 10s grep -Ec "^$$prefix.*: test$$" "$$listed" )" = 21; \
	for name in \
	...
	timeout 10s grep -Fq 'BOOT_TOPOLOGY_ABI_NAME: &str = "cast.boot_topology.v1"' "$$gluon"; \
